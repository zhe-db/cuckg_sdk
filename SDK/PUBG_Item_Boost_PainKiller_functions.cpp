...
void UItem_Boost_PainKiller_C::BoostGaugeUp()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(130152);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(130146);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(130138);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(130134);
