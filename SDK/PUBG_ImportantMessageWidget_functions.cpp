...
void UImportantMessageWidget_C::GetFadeInAnimation(class UWidgetAnimation** Animation)
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(152686);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(152684);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(152683);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(152681);
