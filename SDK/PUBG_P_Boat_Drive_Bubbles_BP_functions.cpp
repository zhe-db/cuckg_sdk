...
#include "PUBG_P_Boat_Drive_Bubbles_BP_parameters.hpp"
...
void AP_Boat_Drive_Bubbles_BP_C::UserConstructionScript()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(114301);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(114300);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(114286);
