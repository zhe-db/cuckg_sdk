...
public:
	...
	struct FVector2D                                   BorderSize;                                               // 0x02A8(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	...
	bool                                               bOverrideCanvasInSize;                                    // 0x02E4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	void HasMessage(bool* bHasMessage);
	void CheckWantRequestRender(bool* bRequestRender);
