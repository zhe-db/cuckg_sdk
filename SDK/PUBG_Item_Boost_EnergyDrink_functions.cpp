...
void UItem_Boost_EnergyDrink_C::BoostGaugeUp()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(113542);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(113536);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(113528);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(113524);
