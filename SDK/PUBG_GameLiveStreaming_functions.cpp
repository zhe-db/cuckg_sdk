...
void UGameLiveStreamingFunctionLibrary::StopWebCam()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(31565);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(31564);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(31559);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(31542);
