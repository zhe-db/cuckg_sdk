...
#include "PUBG_P_Boat_Drive_Ripples_BP_parameters.hpp"
...
void AP_Boat_Drive_Ripples_BP_C::UserConstructionScript()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(114229);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(114228);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(114212);
