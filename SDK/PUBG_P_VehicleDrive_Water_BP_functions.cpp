...
#include "PUBG_P_VehicleDrive_Water_BP_parameters.hpp"
...
void AP_VehicleDrive_Water_BP_C::UserConstructionScript()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(118203);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(118202);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(118191);
