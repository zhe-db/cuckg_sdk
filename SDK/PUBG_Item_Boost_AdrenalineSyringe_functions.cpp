...
void UItem_Boost_AdrenalineSyringe_C::BoostGaugeUp()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(130178);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(130172);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(130164);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(130160);
