...
void UBP_FppWeaponListSlotWidget_C::HIddenEnd__DelegateSignature()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(63090);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(63089);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(63088);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(63087);
