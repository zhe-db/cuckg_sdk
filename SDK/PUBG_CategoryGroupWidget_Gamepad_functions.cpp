...
void UCategoryGroupWidget_Gamepad_C::AddChild(class UWidget** Widget)
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(78071);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(78068);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(78067);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(78055);
