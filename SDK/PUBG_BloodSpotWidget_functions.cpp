...
void UBloodSpotWidget_C::Start()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(78119);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(78118);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(78114);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(78102);
