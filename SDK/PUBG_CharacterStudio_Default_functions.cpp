...
void ACharacterStudio_Default_C::UserConstructionScript()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(59523);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(59521);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(59520);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(59517);
