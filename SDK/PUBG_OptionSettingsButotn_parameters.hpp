...
#include "PUBG_OptionSettingsButotn_classes.hpp"
...
struct UOptionSettingsButotn_C_GetText_1_Params
{
	struct FText                                       ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};

// Function OptionSettingsButotn.OptionSettingsButotn_C.GetColorAndOpacity_1
struct UOptionSettingsButotn_C_GetColorAndOpacity_1_Params
{
...
struct UOptionSettingsButotn_C_BndEvt__Button_0_K2Node_ComponentBoundEvent_20_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function OptionSettingsButotn.OptionSettingsButotn_C.ExecuteUbergraph_OptionSettingsButotn
struct UOptionSettingsButotn_C_ExecuteUbergraph_OptionSettingsButotn_Params
{
	int                                                EntryPoint;                                               // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function OptionSettingsButotn.OptionSettingsButotn_C.OnButtonDown__DelegateSignature
struct UOptionSettingsButotn_C_OnButtonDown__DelegateSignature_Params
{
};
