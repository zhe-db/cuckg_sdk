...
void UBP_TeamMarkWidget_new_2_C::DecideWidgetColors(bool Condition)
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(170689);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(169544);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(169524);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(169519);
