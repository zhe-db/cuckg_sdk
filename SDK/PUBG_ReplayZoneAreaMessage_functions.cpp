...
void UReplayZoneAreaMessage_C::UpdateReplayZoneAreaMessage()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(173154);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(173153);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(173150);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(173144);
