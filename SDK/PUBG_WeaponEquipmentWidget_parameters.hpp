...
#include "PUBG_WeaponEquipmentWidget_classes.hpp"
...
struct UWeaponEquipmentWidget_C_IsFocusable_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function WeaponEquipmentWidget.WeaponEquipmentWidget_C.Down
struct UWeaponEquipmentWidget_C_Down_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function WeaponEquipmentWidget.WeaponEquipmentWidget_C.GetDownWidget
struct UWeaponEquipmentWidget_C_GetDownWidget_Params
{
...
struct UWeaponEquipmentWidget_C_Up_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UWeaponEquipmentWidget_C_MainPrepass_Params
{
	class UWidget*                                     BoundWidget;                                              // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function WeaponEquipmentWidget.WeaponEquipmentWidget_C.InitializeWeaponEquipment
struct UWeaponEquipmentWidget_C_InitializeWeaponEquipment_Params
{
};

// Function WeaponEquipmentWidget.WeaponEquipmentWidget_C.OnDrop
struct UWeaponEquipmentWidget_C_OnDrop_Params
{
...
struct UWeaponEquipmentWidget_C_GetWeaponItemByTabIndex_Params
{
...
struct UWeaponEquipmentWidget_C_Construct_Params
{
};

// Function WeaponEquipmentWidget.WeaponEquipmentWidget_C.OnDragEnter
struct UWeaponEquipmentWidget_C_OnDragEnter_Params
{
	struct FGeometry*                                  MyGeometry;                                               // (Parm, IsPlainOldData)
	struct FPointerEvent*                              PointerEvent;                                             // (Parm)
	class UDragDropOperation**                         Operation;                                                // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UWeaponEquipmentWidget_C_OnDragLeave_Params
{
	struct FPointerEvent*                              PointerEvent;                                             // (Parm)
	class UDragDropOperation**                         Operation;                                                // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UWeaponEquipmentWidget_C_Tick_Params
{
	struct FGeometry*                                  MyGeometry;                                               // (Parm, IsPlainOldData)
...
struct UWeaponEquipmentWidget_C_SetInventoryWidget_Params
{
...
struct UWeaponEquipmentWidget_C_BndEvt__Weapon_01_K2Node_ComponentBoundEvent_19_RefreshFocus__DelegateSignature_Params
{
};
...
struct UWeaponEquipmentWidget_C_BndEvt__Weapon_02_K2Node_ComponentBoundEvent_75_RefreshFocus__DelegateSignature_Params
{
};
...
struct UWeaponEquipmentWidget_C_BndEvt__Weapon_03_K2Node_ComponentBoundEvent_90_RefreshFocus__DelegateSignature_Params
{
};
...
struct UWeaponEquipmentWidget_C_BndEvt__Weapon_04_K2Node_ComponentBoundEvent_106_RefreshFocus__DelegateSignature_Params
{
};
...
struct UWeaponEquipmentWidget_C_ExecuteUbergraph_WeaponEquipmentWidget_Params
{
