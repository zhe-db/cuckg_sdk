...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x00c86928);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x07ed57dd);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x03c280a1);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x039ee3b0);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x08b802a8);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x0ad4aa6c);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x03d5231e);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x0552abc8);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x081f03d0);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x06164718);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x03627e2a);
		return ptr;
	}


	static bool SetLocalNavigationGridDensity(class UObject* WorldContext, float CellSize);
	static void RemoveLocalNavigationGrid(class UObject* WorldContext, int GridId, bool bRebuildGrids);
	...
	static int AddLocalNavigationGridForPoints(class UObject* WorldContext, TArray<struct FVector> Locations, int Radius2D, float Height, bool bRebuildGrids);
	static int AddLocalNavigationGridForPoint(class UObject* WorldContext, const struct FVector& Location, int Radius2D, float Height, bool bRebuildGrids);
	static int AddLocalNavigationGridForCapsule(class UObject* WorldContext, const struct FVector& Location, float CapsuleRadius, float CapsuleHalfHeight, int Radius2D, float Height, bool bRebuildGrids);
	static int AddLocalNavigationGridForBox(class UObject* WorldContext, const struct FVector& Location, const struct FVector& Extent, const struct FRotator& Rotation, int Radius2D, float Height, bool bRebuildGrids);
};
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x06b5e8f5);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x0c90f8e5);
		return ptr;
	}
