...
#include "PUBG_P_VehicleImpact_Vehicle_BP_parameters.hpp"
...
void AP_VehicleImpact_Vehicle_BP_C::UserConstructionScript()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(120083);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(120082);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(120043);
