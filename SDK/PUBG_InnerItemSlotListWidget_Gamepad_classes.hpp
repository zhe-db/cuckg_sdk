...
#include "PUBG_InnerItemSlotListWidget_Gamepad_structs.hpp"
...
// WidgetBlueprintGeneratedClass InnerItemSlotListWidget_Gamepad.InnerItemSlotListWidget_Gamepad_C
// 0x0050 (0x0290 - 0x0240)
class UInnerItemSlotListWidget_Gamepad_C : public UUserWidget
{
public:
	...
	TArray<class UItemSlotWidget_Gamepad_C*>           ItemSlotArray;                                            // 0x0280(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0xab2372c9);
		return ptr;
	}
	...
	void ExecuteUbergraph_InnerItemSlotListWidget_Gamepad(int EntryPoint);
