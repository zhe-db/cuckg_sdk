...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	struct FBoneReference                              RelativeSpaceBone;                                        // 0x0078(0x0018) (Edit, BlueprintVisible)
	bool                                               bChain;                                                   // 0x0090(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0091(0x0007) MISSED OFFSET
	struct FBoneReference                              BoundBone;                                                // 0x0098(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              ChainEnd;                                                 // 0x00B0(0x0018) (Edit, BlueprintVisible)
	struct FVector                                     BoxExtents;                                               // 0x00C8(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     LocalJointOffset;                                         // 0x00D4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              GravityScale;                                             // 0x00E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bLinearSpring;                                            // 0x00E4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAngularSpring;                                           // 0x00E5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bEnableWind;                                              // 0x00F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	float                                              WindScale;                                                // 0x00F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideLinearDamping;                                   // 0x00F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bOverrideAngularDamping;                                  // 0x0100(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bOverrideAngularBias;                                     // 0x0108(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bDoUpdate;                                                // 0x0110(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDoEval;                                                  // 0x0111(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FAnimPhysConstraintSetup                    ConstraintSetup;                                          // 0x011C(0x005C) (Edit, BlueprintVisible)
	bool                                               bUsePlanarLimit;                                          // 0x0178(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x7];                                       // 0x0179(0x0007) MISSED OFFSET
	TArray<struct FAnimPhysPlanarLimit>                PlanarLimits;                                             // 0x0180(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bUseSphericalLimits;                                      // 0x0190(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x7];                                       // 0x0191(0x0007) MISSED OFFSET
	TArray<struct FAnimPhysSphericalLimit>             SphericalLimits;                                          // 0x0198(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
...
{
	struct FBoneReference                              SourceBone;                                               // 0x0070(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              TargetBone;                                               // 0x0088(0x0018) (Edit, BlueprintVisible)
	...
	TEnumAsByte<EBoneControlSpace>                     ControlSpace;                                             // 0x00A3(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_CopyBoneDelta : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bCopyRotation;                                            // 0x00A1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCopyScale;                                               // 0x00A2(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ECopyBoneDeltaMode                                 CopyMode;                                                 // 0x00A3(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_Fabrik : public FAnimNode_SkeletalControlBase
{
	...
	struct FBoneReference                              EffectorTransformBone;                                    // 0x00A8(0x0018) (Edit, BlueprintVisible)
	TEnumAsByte<EBoneRotationSource>                   EffectorRotationSource;                                   // 0x00C0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x00C1(0x0007) MISSED OFFSET
	struct FBoneReference                              TipBone;                                                  // 0x00C8(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              RootBone;                                                 // 0x00E0(0x0018) (Edit, BlueprintVisible)
	float                                              Precision;                                                // 0x00F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxIterations;                                            // 0x00FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableDebugDraw;                                         // 0x0100(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	struct FBoneReference                              RightHandFK;                                              // 0x0070(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              LeftHandFK;                                               // 0x0088(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              RightHandIK;                                              // 0x00A0(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              LeftHandIK;                                               // 0x00B8(0x0018) (Edit, BlueprintVisible)
	TArray<struct FBoneReference>                      IKBonesToMove;                                            // 0x00D0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
...
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
	...
	struct FBoneReference                              LookAtBone;                                               // 0x0088(0x0018) (Edit, BlueprintVisible)
	struct FName                                       LookAtSocket;                                             // 0x00A0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     LookAtLocation;                                           // 0x00A8(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	TEnumAsByte<EAxisOption>                           LookAtAxis;                                               // 0x00B4(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00B5(0x0003) MISSED OFFSET
	struct FVector                                     CustomLookAtAxis;                                         // 0x00B8(0x000C) (Deprecated, IsPlainOldData)
	struct FAxis                                       LookAt_Axis;                                              // 0x00C4(0x0010) (Edit, BlueprintVisible)
	bool                                               bUseLookUpAxis;                                           // 0x00D4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EAxisOption>                           LookUpAxis;                                               // 0x00D5(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x00D6(0x0002) MISSED OFFSET
	struct FVector                                     CustomLookUpAxis;                                         // 0x00D8(0x000C) (Deprecated, IsPlainOldData)
	struct FAxis                                       LookUp_Axis;                                              // 0x00E4(0x0010) (Edit, BlueprintVisible)
	float                                              LookAtClamp;                                              // 0x00F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EInterpolationBlend>                   InterpolationType;                                        // 0x00F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00F9(0x0003) MISSED OFFSET
	float                                              InterpolationTime;                                        // 0x00FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              InterpolationTriggerThreashold;                           // 0x0100(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7C];                                      // 0x0104(0x007C) MISSED OFFSET
};
...
struct FAnimNode_ModifyBone : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<EBoneModificationMode>                 TranslationMode;                                          // 0x00AC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneModificationMode>                 RotationMode;                                             // 0x00AD(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneModificationMode>                 ScaleMode;                                                // 0x00AE(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     TranslationSpace;                                         // 0x00AF(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     RotationSpace;                                            // 0x00B0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     ScaleSpace;                                               // 0x00B1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	struct FBoneReference                              TargetBone;                                               // 0x0070(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              SourceBone;                                               // 0x0088(0x0018) (Edit, BlueprintVisible)
	float                                              Multiplier;                                               // 0x00A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneAxis>                             RotationAxisToRefer;                                      // 0x00A4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsAdditive;                                              // 0x00A5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	struct FBoneReference                              StartBone;                                                // 0x0070(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              EndBone;                                                  // 0x0088(0x0018) (Edit, BlueprintVisible)
	ESplineBoneAxis                                    BoneAxis;                                                 // 0x00A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAutoCalculateSpline;                                     // 0x00A1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x00A2(0x0002) MISSED OFFSET
	int                                                PointCount;                                               // 0x00A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FAlphaBlend                                 TwistBlend;                                               // 0x00C8(0x0038) (Edit, BlueprintVisible)
...
{
	struct FBoneReference                              SpringBone;                                               // 0x0070(0x0018) (Edit, BlueprintVisible)
	bool                                               bLimitDisplacement;                                       // 0x0088(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0089(0x0003) MISSED OFFSET
	float                                              MaxDisplacement;                                          // 0x008C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SpringStiffness;                                          // 0x0090(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SpringDamping;                                            // 0x0094(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ErrorResetThresh;                                         // 0x0098(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bNoZSpring;                                               // 0x009C(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bTranslateX;                                              // 0x009D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bTranslateY;                                              // 0x009E(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bTranslateZ;                                              // 0x009F(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bRotateX;                                                 // 0x00A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bRotateY;                                                 // 0x00A1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bRotateZ;                                                 // 0x00A2(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	struct FBoneReference                              TrailBone;                                                // 0x0070(0x0018) (Edit, BlueprintVisible)
	int                                                ChainLength;                                              // 0x0088(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EAxis>                                 ChainBoneAxis;                                            // 0x008C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bInvertChainBoneAxis;                                     // 0x008D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FRuntimeFloatCurve                          TrailRelaxationSpeed;                                     // 0x0098(0x0078) (Edit, BlueprintVisible)
	...
	struct FVector                                     FakeVelocity;                                             // 0x0118(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	...
	struct FBoneReference                              BaseJoint;                                                // 0x0128(0x0018) (Edit, BlueprintVisible)
...
{
	struct FBoneReference                              IKBone;                                                   // 0x0070(0x0018) (Edit, BlueprintVisible)
	...
	float                                              StartStretchRatio;                                        // 0x00B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxStretchScale;                                          // 0x00B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     EffectorLocationSpace;                                    // 0x00BC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     JointTargetLocationSpace;                                 // 0x00BD(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x00BE(0x0002) MISSED OFFSET
	struct FName                                       JointTargetSpaceBoneName;                                 // 0x00C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
