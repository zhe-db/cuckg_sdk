...
#include "PUBG_AircraftCarePackage_FlareGun_structs.hpp"
...
// BlueprintGeneratedClass AircraftCarePackage_FlareGun.AircraftCarePackage_FlareGun_C
// 0x002C (0x053C - 0x0510)
class AAircraftCarePackage_FlareGun_C : public AAircraftCarePackage
{
public:
	...
	static UClass* StaticClass()
	{
		...
		if (!ptr) ptr = UObject::FindClass(0xd665663d);
		return ptr;
	}
	...
	void ExecuteUbergraph_AircraftCarePackage_FlareGun(int EntryPoint);
};
