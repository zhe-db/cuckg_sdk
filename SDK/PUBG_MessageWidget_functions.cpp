...
void UMessageWidget_C::ClearMessage()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(153610);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(153609);
...
// Function MessageWidget.MessageWidget_C.Unknown4281_1
// (BlueprintCallable, BlueprintEvent)

void UMessageWidget_C::Unknown9725_1()
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(153608);

	UMessageWidget_C_Unknown9725_1_Params params;
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(153604);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(153602);
