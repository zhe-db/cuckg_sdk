...
{
public:
	class UPaperFlipbookComponent*                     Sprite;                                                   // 0x07D0(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x07D8(0x0008) MISSED OFFSET

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x0f5c20ea);
		return ptr;
	}
...
{
public:
	class UPaperFlipbook*                              SourceFlipbook;                                           // 0x0950(0x0008) (Edit, Net, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          Material;                                                 // 0x0958(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x0960(0x0004) (Edit, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bLooping : 1;                                             // 0x0964(0x0001) (Net)
	unsigned char                                      bReversePlayback : 1;                                     // 0x0964(0x0001) (Net)
	unsigned char                                      bPlaying : 1;                                             // 0x0964(0x0001) (Net)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0965(0x0003) MISSED OFFSET
	float                                              AccumulatedTime;                                          // 0x0968(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	int                                                CachedFrameIndex;                                         // 0x096C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                SpriteColor;                                              // 0x0970(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	class UBodySetup*                                  CachedBodySetup;                                          // 0x0980(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnFinishedPlaying;                                        // 0x0988(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x0d9508fd);
		return ptr;
	}
...
{
public:
	TArray<class UMaterialInterface*>                  InstanceMaterials;                                        // 0x0950(0x0010) (ZeroConstructor)
	TArray<struct FSpriteInstanceData>                 PerInstanceSpriteData;                                    // 0x0960(0x0010) (Edit, ZeroConstructor)
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x0892d00c);
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x01e1b654);
		return ptr;
	}
...
{
public:
	class UPaperSprite*                                SourceSprite;                                             // 0x0950(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaterialOverride;                                         // 0x0958(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FLinearColor                                SpriteColor;                                              // 0x0960(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
...
public:
	...
	TEnumAsByte<ESpriteCollisionMode>                  SpriteCollisionDomain;                                    // 0x087C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                MapWidth;                                                 // 0x0950(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	int                                                MapHeight;                                                // 0x0954(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	int                                                TileWidth;                                                // 0x0958(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	int                                                TileHeight;                                               // 0x095C(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UPaperTileSet*                               DefaultLayerTileSet;                                      // 0x0960(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UMaterialInterface*                          Material;                                                 // 0x0968(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	TArray<class UPaperTileLayer*>                     TileLayers;                                               // 0x0970(0x0010) (ZeroConstructor, Deprecated)
	struct FLinearColor                                TileMapColor;                                             // 0x0980(0x0010) (Edit, IsPlainOldData)
	int                                                UseSingleLayerIndex;                                      // 0x0990(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseSingleLayer;                                          // 0x0994(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0995(0x0003) MISSED OFFSET
	class UPaperTileMap*                               TileMap;                                                  // 0x0998(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
