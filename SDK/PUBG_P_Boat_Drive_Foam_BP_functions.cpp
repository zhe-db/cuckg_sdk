...
#include "PUBG_P_Boat_Drive_Foam_BP_parameters.hpp"
...
void AP_Boat_Drive_Foam_BP_C::UserConstructionScript()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(114280);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(114279);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(114260);
